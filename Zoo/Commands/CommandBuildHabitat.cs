...
public class CommandBuildHabitat(GameController controller) : Command
{
    ...
    public override string ActionDescription() => "Buduje wybieg na mapie. Użycie: buduj <x> <y> <ladowe/wodne>";
    ...
    public override bool Execute(List<string> args)
    {
        ...
        {
            controller.GameDisplay.DisplayWarning("Nie udało się zbudować wybiegu w tym miejscu");
            return false;
        }
        return true;
    }
